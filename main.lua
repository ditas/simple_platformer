...
function love.load()
    ...
    spawnObject(150, 150, 300, 50, true)
        spawnObject(350, 250, 300, 50, true)

        spawnObject(350, 400, 450, 50, true)
    ...
    dynamic = Player:new(id, 1000, 0, nil, 64, 64, nil, 10)
    dynamic:setScale(2)
    dynamic:setDeathZone({-1000, -2000, 2000, 2000})
    dynamic2 = Player:new(opponentId, 1050, 0, nil, 64, 64, nil, 10)
    dynamic2:setScale(2)
